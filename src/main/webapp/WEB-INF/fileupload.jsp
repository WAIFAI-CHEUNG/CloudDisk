		...
		<div class="cloud">
			<div class="banner">
				...
				<div class="bannerCenter">
					<ul>
						<li><a href="<%=basePath%>user/pass.action">网盘</a></li>
						<li><a href="index.do">分享</a></li>
						<li class="active"><a href="<%=basePath%>user/fileuploadWeb.action">正在上传</a></li>
						<li><a href="<%=basePath%>user/filedwonloadWeb.action">正在下载</a></li>
					</ul>
				</div>
